...
function ApplicationTime() {
  ...
  return (
    <div className="col-span-12 xl:col-span-8 bg-white bg-slate-800 dark:bg-slate-800 rounded-sm border border-slate-200 dark:border-slate-700">
      ...
      <div className="grow">
        ...
        {labels && <LineChart data={chartData} width={389} height={450} />}
      </div>
    </div>
  );
}
